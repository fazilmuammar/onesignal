...
/**
 * Activity for RecyclerAdapter List Article layout resources
 *
 * Class ini untuk membuat adapter list article yang telah dibuat di List Article
 *
 * @author Ekreasi
 * @version 1.0.0
 * @since 1.0.0
...
public class CustomRecycleradapter extends RecyclerView.Adapter<CustomRecycleradapter.MyHolder> {
    ...
    private String img_path,img_paths;


    public CustomRecycleradapter(List<ResultItemListArticle> result, FragmentActivity c) {
        this.data = result;
        this.mContext = c;
    ...
    public void onBindViewHolder(MyHolder holder, final int position) {
        ...
        /**
         * Membuat method untuk pindah ke Article Detail dari list article
        ...
        img_paths=("http://fazilmuammar007.com/blogapp/images_signature/" + data.get(position).getSignature());
        holder.img_path=img_path;
        holder.img_paths=img_paths;
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
       ...
       private TextView email,category, tanggals, phones,author,content ;
        ...
        public String CONTENT_ID,img_path,img_paths;
        public MyHolder(View itemView) {
            ...
            /**
             * Membuat method untuk pindah ke Edit Article dari list article
            ...
            edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    pindah.putExtra("signature",   img_paths);
        ...
        /**
         * method yang digunakan untuk membuat hapus  article di List Article dan connect ke server menggunakan retrofit
